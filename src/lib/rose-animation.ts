...
export const ROSE_MODEL_URL = "/models/rose.glb?v=guided-bud-3";
...
export const ROSE_PRESENTATION_START_MS = ROSE_ASSEMBLY_MS - 500;
export const ROSE_PRESENTATION_DURATION_MS = 2_600;
